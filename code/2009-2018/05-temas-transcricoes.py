...
PATH_TEMAS_TRANSCRICOES = './data/2009-2018/05-temas-transcricoes.csv'
PATH_TERMOS_PRINCIPAIS = './data/2009-2018/05-termos-principais.csv'
...
vetorizador = CountVectorizer(min_df=percentis['5'],
                              max_df=percentis['80'],
                              max_features=None,
                              ngram_range=(1, 2),
                              lowercase=False,
